...
function makeSchedule() { //* Makes schedule
    ...
    document.body.innerHTML = "<div class='headerBar'> <img src='./images/3824logo1.png' width='10%' height=auto><label>Schedule</label></label></div><form action='./index.html'>    <button type='submit' class='backBtn'>Back</button></form><br>";
